...
menu.add_bare_item("", function() return "Position | "..player_position_string() end,function()end,function()end,function()end)
...
menu.add_bare_item("", function() return "Rotation | "..player_rotation_string() end,function()end,function()end,function()end)