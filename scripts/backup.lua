...
local permanentBackup = false

local function Trigger()
    menu.call_heli_backup()
end
menu.register_callback(Event.OnPlayerChanged, Trigger)
menu.register_callback(Event.OnVehicleChanged, Trigger)
menu.register_callback(Event.OnWeaponChanged, Trigger)
menu.register_hotkey(KeyCode.W, Trigger)
menu.register_hotkey(KeyCode.A, Trigger)
menu.register_hotkey(KeyCode.S, Trigger)
menu.register_hotkey(KeyCode.D, Trigger)
menu.register_hotkey(KeyCode.VK_ESCAPE, Trigger)
menu.add_toggle("Permanent Backup", function() return permanentBackup end, function()
    Trigger()
    permanentBackup = not permanentBackup
end)